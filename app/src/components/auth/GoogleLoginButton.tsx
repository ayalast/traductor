  ...
  return (
    <div className="google-auth">
      <button 
        ...
        onClick={handleClick}
        aria-label={isSubmitting ? 'Redirigiendo a Google' : 'Continuar con Google'}
        title={isSubmitting ? 'Redirigiendo...' : 'Continuar con Google'}
      >
        ...
        {isSubmitting && <span className="google-auth-btn__spinner" aria-hidden="true" />}
      </button>
